...
import * as BaseDemo from 'docs-solid2/src/blocks/Demo';
import { CheckIcon } from 'docs-solid2/src/icons/CheckIcon';
import { CopyIcon } from 'docs-solid2/src/icons/CopyIcon';
