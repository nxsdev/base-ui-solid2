import { Link } from 'docs-solid2/src/components/Link';
import { Logo } from 'docs-solid2/src/components/Logo';
import { ArrowRightIcon } from 'docs-solid2/src/icons/ArrowRightIcon';
import './index.css';
