import { createEffect, createSignal, createTrackedEffect, onCleanup, onSettled, type Accessor } from 'solid-js';
import { createStore, type StoreSetter, type Store } from 'solid-js';
import {
  FloatingRootContext,
  useClick,
  useDismiss,
...
export function useDialogRoot(params: useDialogRoot.Parameters): useDialogRoot.ReturnValue {
  ...
  createEffect(
    () => [codependentRefs.title, codependentRefs.description] as const,
    ([title, description]) => {
