import { createMemo, omit, type ComponentProps } from 'solid-js';
...
export function InternalBackdrop(props: InternalBackdrop.Props) {
  const otherProps = omit(props, 'cutout', 'managed');
  ...
  const ownerProps = () => (props.managed ? { [createAttribute('managed')]: props.managed } : {});
