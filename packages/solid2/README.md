...
[![npm](https://img.shields.io/npm/v/@base-ui/solid2)](https://www.npmjs.com/package/@base-ui/solid2)

## Installation

```bash
npm install @base-ui/solid2
```
...
Please consider supporting the Base UI team directly on [OpenCollective](https://opencollective.com/mui-org). This port is a gesture of appreciation for the incredible work they've been doing.
